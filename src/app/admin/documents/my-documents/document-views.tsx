...
interface ViewProps {
  ...
  setSelectedIds: React.Dispatch<React.SetStateAction<Set<string | number>>> // Pastikan ini ada
...
// Komponen Reusable untuk Isi Menu (Shared antara ContextMenu dan DropdownMenu)
const MenuItems = ({ item, onRename, onDownload, onDelete, onToggleShare }: { item: DocumentItem; onRename: (item: DocumentItem) => void; onDownload: (item: DocumentItem) => void; onDelete: (item: DocumentItem) => void; onToggleShare: (item: DocumentItem) => void }) => (
  <>
...
// --- GRID VIEW COMPONENT ---
export function GridView({ documents, onFolderClick, formatSize, onDelete, onRename, onDownload, selectedIds, setSelectedIds, onSelect, onToggleShare }: ViewProps) {  return (
